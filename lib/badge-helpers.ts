/**
 * GVC Badge Helpers (Legacy)
 *
 * Lightweight helpers for map-derived holder badge views.
 *
 * This module does not cover every badge rule. For canonical full-badge
 * evaluation, use BadgeRuleEngine with badge-definitions.json.
 */
...
const COLLECTOR_MILESTONES: { threshold: number; badge: string }[] = [
  ...
  { threshold: 69, badge: "unfathomable_vibes" },
];
